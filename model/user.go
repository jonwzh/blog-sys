...
type User struct {
	...
	Posts     []Post
	Followers []*User `gorm:"many2many:follower;association_jointable_foreignkey:follower_id"` // TODO
}

// SetPassword func: Set the PasswordHash
func (u *User) SetPassword(password string) {
	u.PasswordHash = GeneratePasswordHash(password)
}

// CheckPassword func: Check if the password is the same as stored
